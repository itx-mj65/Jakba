...
$(function () {
    ...
    ***************************/
    ...
    // $(document).on('click', 'a[href^="https://www.facebook.com/CorvitSystemsFaisalabad/"]', function (event) {
    //     event.preventDefault();
    ...
    //         }, 400);
    //     } else {
    //         window.open($.attr(this, 'href'), '_blank');
    //     }
    // });
    ...
    // $(document).on('click', 'a.social-icon', function (event) {
    //     var url = $(this).attr('href');
